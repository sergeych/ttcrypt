...
describe 'rsa-oaep' do
  ...
  def init_test_vectors
    ...
    @message = h2i 'd4 36 e9 95 69 fd 32 a7 c8 a0 5b bc 90 d3 2c 49'

    @pHash = h2i 'da 39 a3 ee 5e 6b 4b 0d 32 55 bf ef 95 60 18 90 af d8 07 09'

    @seed = h2i 'aa fd 12 f6 59 ca e6 34 89 b4 79 e5 07 6d de c2 f0 6c b5 8f'
